%% Separate Data Based on Stim On/Off

function OnOff = separatetData(time,Data,Fs,blocks,start_art,stop_art)
...
%Data = sig; % use Raw Data 
OnOff = cell(length(blocks),(length(start_art)+2),2,2); % initialize cell array to number of stims +2 baselines 
