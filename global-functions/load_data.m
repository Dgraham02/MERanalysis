...
function [file_path] = load_data(patient_id, USER)

    if contains(USER,'workstation')
        % Workstation Paths
        patient_folder = "G:\Dakota\dbs-study\patient-" + patient_id;
        function_folder = 'G:\Dakota\dbs-study\global-functions';
        data_folder = 'G:\DBS Study Data';
        file_path = "G:\DBS Study Data\" + patient_id + "_Ipsilateral.mat";
    elseif contains(USER,'dakota') 
        % Dakota's Paths
        patient_folder = "C:\Users\Dakota\dbs-study\patient-" + patient_id;
        function_folder = 'C:\Users\Dakota\dbs-study\global-functions';
        data_folder = 'D:\DBS Study\DBS DATA';
        file_path = "D:\DBS Study\DBS DATA\" + patient_id + "_Ipsilateral.mat";
